...
const Navbar = () => {
  ...
  return (
    <nav className="w-full z-50 bg-neutral-950 px-6 py-4">
      {/* Desktop Navbar */}
      ...
      {isOpen && (
        <div onClick={toggleMenu} className="d:hidden fixed inset-0 top-[60px] z-40 bg-black/40 backdrop-blur-md flex flex-col items-center justify-center gap-8 text-xl text-gray-300">
          ...
          <a href="#contact" onClick={toggleMenu} className="px-6 py-2 bg-neutral-950 text-gray-300 border border-gray-500 rounded-full hover:bg-gray-500 transition duration-300 ease-in-out hover:text-neutral-950">
            Get in Touch
          </a>
        </div>
      )}
